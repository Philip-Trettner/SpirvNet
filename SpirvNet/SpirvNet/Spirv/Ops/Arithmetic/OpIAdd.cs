...
namespace SpirvNet.Spirv.Ops.Arithmetic
{
    ...
    /// </summary>
    public sealed class OpIAdd : ArithmeticInstruction
    {
        public override bool IsArithmetic => true;
        public override OpCode OpCode => OpCode.IAdd;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.IAdd);
            var i = start + 1;
