...
namespace SpirvNet.Spirv.Ops.Arithmetic
{
    ...
    /// </summary>
    public sealed class OpUMod : ArithmeticInstruction
    {
        public override bool IsArithmetic => true;
        public override OpCode OpCode => OpCode.UMod;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.UMod);
            var i = start + 1;
