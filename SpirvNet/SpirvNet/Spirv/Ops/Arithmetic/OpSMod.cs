...
namespace SpirvNet.Spirv.Ops.Arithmetic
{
    ...
    /// </summary>
    public sealed class OpSMod : ArithmeticInstruction
    {
        public override bool IsArithmetic => true;
        public override OpCode OpCode => OpCode.SMod;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.SMod);
            var i = start + 1;
