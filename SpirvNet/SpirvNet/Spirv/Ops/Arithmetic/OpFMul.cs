...
namespace SpirvNet.Spirv.Ops.Arithmetic
{
    ...
    /// </summary>
    public sealed class OpFMul : ArithmeticInstruction
    {
        public override bool IsArithmetic => true;
        public override OpCode OpCode => OpCode.FMul;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.FMul);
            var i = start + 1;
