...
namespace SpirvNet.Spirv.Ops.RelationalAndLogical
{
    ...
    /// </summary>
    public sealed class OpFOrdEqual : RelationalAndLogicalInstruction
    {
        public override bool IsRelationalAndLogical => true;
        public override OpCode OpCode => OpCode.FOrdEqual;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.FOrdEqual);
            var i = start + 1;
