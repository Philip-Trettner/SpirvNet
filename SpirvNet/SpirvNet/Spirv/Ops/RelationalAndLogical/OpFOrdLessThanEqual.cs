...
namespace SpirvNet.Spirv.Ops.RelationalAndLogical
{
    ...
    /// </summary>
    public sealed class OpFOrdLessThanEqual : RelationalAndLogicalInstruction
    {
        public override bool IsRelationalAndLogical => true;
        public override OpCode OpCode => OpCode.FOrdLessThanEqual;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.FOrdLessThanEqual);
            var i = start + 1;
