...
namespace SpirvNet.Spirv.Ops.RelationalAndLogical
{
    ...
    /// </summary>
    public sealed class OpSGreaterThanEqual : RelationalAndLogicalInstruction
    {
        public override bool IsRelationalAndLogical => true;
        public override OpCode OpCode => OpCode.SGreaterThanEqual;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.SGreaterThanEqual);
            var i = start + 1;
