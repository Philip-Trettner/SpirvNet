...
namespace SpirvNet.Spirv.Ops.RelationalAndLogical
{
    ...
    /// </summary>
    public sealed class OpLogicalAnd : RelationalAndLogicalInstruction
    {
        public override bool IsRelationalAndLogical => true;
        public override OpCode OpCode => OpCode.LogicalAnd;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.LogicalAnd);
            var i = start + 1;
