...
namespace SpirvNet.Spirv.Ops.RelationalAndLogical
{
    ...
    /// </summary>
    public sealed class OpULessThan : RelationalAndLogicalInstruction
    {
        public override bool IsRelationalAndLogical => true;
        public override OpCode OpCode => OpCode.ULessThan;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.ULessThan);
            var i = start + 1;
