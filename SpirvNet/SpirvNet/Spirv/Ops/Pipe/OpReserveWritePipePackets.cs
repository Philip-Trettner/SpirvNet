...
namespace SpirvNet.Spirv.Ops.Pipe
{
    ...
    public sealed class OpReserveWritePipePackets : PipeInstruction
    {
        public override bool IsPipe => true;
        public override OpCode OpCode => OpCode.ReserveWritePipePackets;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.ReserveWritePipePackets);
            var i = start + 1;
