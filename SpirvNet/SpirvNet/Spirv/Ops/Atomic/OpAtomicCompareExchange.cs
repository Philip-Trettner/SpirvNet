...
namespace SpirvNet.Spirv.Ops.Atomic
{
    ...
    /// </summary>
    public sealed class OpAtomicCompareExchange : AtomicInstruction
    {
        public override bool IsAtomic => true;
        public override OpCode OpCode => OpCode.AtomicCompareExchange;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.AtomicCompareExchange);
            var i = start + 1;
