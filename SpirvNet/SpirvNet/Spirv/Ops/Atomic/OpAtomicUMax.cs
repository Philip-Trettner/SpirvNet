...
namespace SpirvNet.Spirv.Ops.Atomic
{
    ...
    /// </summary>
    public sealed class OpAtomicUMax : AtomicInstruction
    {
        public override bool IsAtomic => true;
        public override OpCode OpCode => OpCode.AtomicUMax;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.AtomicUMax);
            var i = start + 1;
