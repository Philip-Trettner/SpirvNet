...
namespace SpirvNet.Spirv.Ops.Atomic
{
    ...
    /// </summary>
    public sealed class OpAtomicUMin : AtomicInstruction
    {
        public override bool IsAtomic => true;
        public override OpCode OpCode => OpCode.AtomicUMin;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.AtomicUMin);
            var i = start + 1;
