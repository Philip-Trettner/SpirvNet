...
namespace SpirvNet.Spirv.Ops.Atomic
{
    ...
    /// </summary>
    public sealed class OpAtomicExchange : AtomicInstruction
    {
        public override bool IsAtomic => true;
        public override OpCode OpCode => OpCode.AtomicExchange;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.AtomicExchange);
            var i = start + 1;
