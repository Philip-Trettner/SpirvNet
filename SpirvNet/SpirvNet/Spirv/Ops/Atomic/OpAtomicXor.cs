...
namespace SpirvNet.Spirv.Ops.Atomic
{
    ...
    /// </summary>
    public sealed class OpAtomicXor : AtomicInstruction
    {
        public override bool IsAtomic => true;
        public override OpCode OpCode => OpCode.AtomicXor;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.AtomicXor);
            var i = start + 1;
