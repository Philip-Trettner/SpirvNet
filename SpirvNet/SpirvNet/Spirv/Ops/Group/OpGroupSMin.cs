...
namespace SpirvNet.Spirv.Ops.Group
{
    ...
    public sealed class OpGroupSMin : GroupInstruction
    {
        public override bool IsGroup => true;
        public override OpCode OpCode => OpCode.GroupSMin;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.GroupSMin);
            var i = start + 1;
