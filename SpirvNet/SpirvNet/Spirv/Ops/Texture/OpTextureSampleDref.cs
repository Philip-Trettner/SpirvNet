...
namespace SpirvNet.Spirv.Ops.Texture
{
    ...
    public sealed class OpTextureSampleDref : Instruction
    {
        ...
        public override string ToString() => '(' + OpCode + '(' + (int)OpCode + ")" + ", " + ResultType + ", " + Result + ", " + Sampler + ", " + Coordinate + ", " + Dref + ')';
