...
namespace SpirvNet.Spirv.Ops.Texture
{
    ...
    public sealed class OpTextureSampleProjGrad : Instruction
    {
        public override bool IsTexture => true;
        public override OpCode OpCode => OpCode.TextureSampleProjGrad;
        ...
        {
            System.Diagnostics.Debug.Assert((codes[start] & 0x0000FFFF) == (uint)OpCode.TextureSampleProjGrad);
            var i = 1;
